...
dataset_type = 'CustomTemporalWaymoDataset'
data_root = 'data/waymo/kitti_format/'
file_client_args = dict(backend='disk')


train_pipeline = [
    dict(type='LoadMultiViewImageFromFilesWithPad', to_float32=True, img_scale=(1280,1920)),
...
lr_config = dict(
    ...
    min_lr_ratio=1e-3)
total_epochs = 24
evaluation = dict(interval=2, pipeline=test_pipeline, metric='waymo', pklfile_prefix='work_dirs/bevformer_tiny_waymo_temporal/',)
...
resume_from = 'work_dirs/bevformer_tiny_waymo_temporal/latest.pth'