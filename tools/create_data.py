...
from data_converter import once_converter as once
...
def once_data_prep(root_path, info_prefix, version, out_dir):
    ...
    once.create_once_info_file(root_path, info_prefix)
